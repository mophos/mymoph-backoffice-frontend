...
export class SidebarComponent {
  private readonly iconMap: Record<string, string> = {
    ...
    person_search: 'M10 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0 10c-4.42 0-8 2-8 4.5V21h10.35a7 7 0 0 1-.35-2.2c0-1.76.65-3.37 1.73-4.6A13.82 13.82 0 0 0 10 14Zm8.5 0a4.5 4.5 0 1 0 2.83 8l2.34 2.33 1.41-1.41-2.33-2.34A4.5 4.5 0 0 0 18.5 14Zm0 2a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z',
